...
const defaultData = {
  ...
  calendarioSanitario: [
    { id: 1, propriedadeId: 1, doenca: "Brucelose", mes: "Maio", publico: "Fêmeas 3-8 meses", obrigatorio: true },
    { id: 2, propriedadeId: 1, doenca: "Raiva", mes: "Novembro", publico: "Todo o rebanho", obrigatorio: true }
  ],
...
export default function App() {
  ...
  // 2. Conectar à Nuvem isolada DO UTILIZADOR (Armazenamento Individual Garantido)
  useEffect(() => {
  ...
  // LEITE: Modificado para puxar todas as Fêmeas em vez de apenas "Aptidão Leite" para não falhar
  const gadoDeLeite = useMemo(() => cAnimais.filter(a => a.sexo === 'F'), [cAnimais]);
